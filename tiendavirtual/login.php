...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // usar filter_input para mayor seguridad
    $email = trim(filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL));
    $password = trim($_POST['password']); // plain text según tu diseño actual
...
<link rel="stylesheet" href="CSS/logi.css"> <!-- o auth.css si usas ese -->
</head>
<body>
